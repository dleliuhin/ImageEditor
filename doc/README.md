...
(Source code is the deliverable)
 ...
 2. We should be able to zoom into any rectangular subregion of the image. <s>The plan is to open the zoomed area in a new window.</s> As long as it is done serially one after the other; we should be able to zoom into multiple subregions and make edits.
